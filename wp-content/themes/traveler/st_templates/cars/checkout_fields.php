    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="form-group">
                <label for="field-car-drive-name"><?php st_the_language('driver_name') ?> <span class="require">*</span></label>
            ...
            <div class="form-group">
                <label for="field-car-drive-age"><?php st_the_language('driver_age') ?> <span class="require">*</span></label>
