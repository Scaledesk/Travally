...
<div class="<?php  if($st_direction=='horizontal') echo 'row';?>">
    <div class="col-md-<?php echo esc_attr($size) ?>">
        <div  class="form-group form-group-<?php echo esc_attr($field_size) ?> form-group-icon-left"  data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>">
            ...
            <input id="field-car-pickup-date" placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" value="<?php echo STInput::request('pick-up-date') ?>" <?php echo esc_attr($is_required) ?>  class="form-control pick-up-date <?php echo esc_attr($is_required) ?>" name="pick-up-date" type="text" />
        </div>
    </div>
    <div class="col-md-<?php echo esc_attr($size) ?>">
        <div class="form-group form-group-<?php echo esc_attr($field_size) ?> form-group-icon-left">
            ...
            <input id="field-car-pickup-time" name="pick-up-time" class="time-pick form-control <?php echo esc_attr($is_required) ?>" <?php echo esc_attr($is_required) ?> value="<?php echo STInput::get('pick-up-time')?>" type="text" />
        </div>
    </div>
</div>
