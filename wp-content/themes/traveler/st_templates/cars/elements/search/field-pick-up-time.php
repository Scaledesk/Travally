...
<div class="form-group form-group-<?php echo esc_attr($field_size) ?> form-group-icon-left">
    ...
    <input id="field-car-pickup-time" name="pick-up-time" <?php echo esc_attr($is_required) ?> class="time-pick form-control <?php echo esc_attr($is_required) ?>" value="<?php echo STInput::request('pick-up-time') ?>" type="text" />
</div>