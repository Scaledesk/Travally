...
<div class="<?php  if($st_direction=='horizontal') echo 'row';?>" >
    <div class="col-md-<?php echo esc_attr($size) ?>">
        <div  class="form-group form-group-<?php echo esc_attr($field_size) ?> form-group-icon-left">
            ...
            <input id="field-st-dropoff-date" placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" value="<?php echo STInput::request('drop-off-date') ?>" <?php echo esc_attr($is_required) ?> class="form-control drop-off-date <?php echo esc_attr($is_required) ?>" name="drop-off-date" type="text" />
        </div>
    </div>
    <div class="col-md-<?php echo esc_attr($size) ?>">
        <div class="form-group form-group-<?php echo esc_attr($field_size) ?> form-group-icon-left">
            ...
            <input id="field-st-dropoff-time" name="drop-off-time" <?php echo esc_attr($is_required) ?> class="time-pick form-control <?php echo esc_attr($is_required) ?>" value="<?php echo STInput::get('drop-off-time')?>" type="text" />
        </div>
    </div>
</div>