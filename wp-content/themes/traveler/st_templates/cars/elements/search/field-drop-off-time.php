...
<div class="form-group form-group-<?php echo esc_attr($field_size) ?> form-group-icon-left">
    ...
    <input id="field-st-dropoff-time" name="drop-off-time"  class="time-pick form-control <?php echo esc_attr($is_required) ?>" <?php echo esc_attr($is_required) ?> value="<?php echo STInput::request('drop-off-time') ?>" type="text"  />
</div>