...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <label for="field-car-pickup-fromlist"><?php echo esc_html( $title)?></label>
    <i class="fa fa-map-marker input-icon"></i>
   <select id="field-car-pickup-fromlist" name="location_id_pick_up" class="form-control" <?php echo esc_attr($is_required) ?>>
