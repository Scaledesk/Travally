      				...
      				<div class="row">
      					...
      					<div class="col-xs-12 col-sm-4">
      						<div class="form-group">
		      					...
		      					?>
		      						<select name="infant_number" id="infant_number" class="form-control" style="width: 100px;">
      					...
      					<div class="col-xs-12 col-sm-6">
      						<div class="form-group">
		      					...
		      					<div class="input-group">
								  	...
								  	<input readonly data-date-format="<?php echo TravelHelper::getDateFormatJs() ?>" aria-describedby="basic-checkin" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="check_in" id="check_in" value="<?php echo $check_in; ?>" class="form-control">
								</div>
		      				</div>
      					</div>
      					<div class="col-xs-12 col-sm-6">
      						<div class="form-group">
		      					...
		      					<div class="input-group">
								  	...
								  	<input data-date-format="<?php echo TravelHelper::getDateFormatJs() ?>" readonly aria-describedby="basic-checkout" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="check_out" id="check_out" value="<?php echo $check_out; ?>" class="form-control">
							  	</div>
		      				</div>
      					</div>
      				</div>
