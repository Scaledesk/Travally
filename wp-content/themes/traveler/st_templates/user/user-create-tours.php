...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner" class="<?php echo STUser_f::get_status_msg(); ?>">
    ...
    <div class="form-group form-group-icon-left">
        ...
        <input id="title" name="title" type="text" placeholder="<?php echo __('Name of Tour', ST_TEXTDOMAIN); ?>" value="<?php echo STInput::request('title') ?>" class="form-control">
    ...
    <div class="form-group ">
        ...
        <textarea id="desc" name="desc" rows="6" class="form-control"><?php echo stripslashes(STInput::request( 'desc' )) ?></textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 data_duration">
                        <div class="form-group form-group-icon-left">
                            ...
                            <i class="fa fa-star input-icon input-icon-hightlight"></i>
                            <input id="duration" name="duration" type="text" placeholder="<?php _e("Duration",ST_TEXTDOMAIN) ?>" class="form-control number" value="<?php echo STInput::request('duration') ?>">
