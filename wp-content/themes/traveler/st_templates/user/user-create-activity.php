...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner" class="<?php echo STUser_f::get_status_msg(); ?>">
    ...
    <div class="form-group form-group-icon-left">
        ...
        <input id="title" name="title" type="text"
               placeholder="<?php echo __('Name of Activity', ST_TEXTDOMAIN); ?>" class="form-control" value="<?php echo STInput::request('title') ?>">
                    ...
                    <div class="col-md-6">
                        <div class='form-group form-group-icon-left'>
                            ...
                            if(!empty($layout) and is_array($layout)):
                                ?>
                                <select id="st_custom_layout" class='form-control' name='st_custom_layout'>
                                    <?php
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 clear">
                        <div class="form-group form-group-icon-left">
                            ...
                            <select class="form-control st_activity_external_booking" name="st_activity_external_booking">
