...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner" class="<?php echo STUser_f::get_status_msg(); ?>">
    ...
    <div class="form-group form-group-icon-left">
        ...
        <input id="title" name="title" type="text" placeholder="<?php _e("Name of Hotel",ST_TEXTDOMAIN) ?>" class="form-control" value="<?php echo STInput::request('title') ?>">
                                ...
                                <div class="row">
                                    ...
                                    <?php foreach($options as $k=>$v):
                                        ...
                                        <div class="col-md-3">
                                            <div class="checkbox-inline checkbox-stroke">
                                                <label for="card_accepted">
                                                    <input <?php echo esc_attr($check) ?> name="card_accepted[]" class="i-check item_tanoxomy" type="checkbox" value="<?php echo esc_attr($value) ?>" /><?php echo esc_html($v['title']) ?>
                                                </label>
                                            </div>
                                        </div>
                                    <?php endforeach ?>
