      			...
      			<div class="panel-body">
	      			...
	      			<div class="row">
	      				<div class="col-xs-6 col-sm-3">
	      					<div class="form-group">
	      						<a href="#" class="btn btn-primary" id="tour_time" data-toggle="modal" data-target="#calendar_tour_modal"><?php echo __('Select a tour', ST_TEXTDOMAIN); ?></a>
	      					</div>
	      				</div>
	      			</div>
      				<div class="row">
      				...
      				<div class="row">
      					...
      					<div class="col-xs-12 col-sm-6">
      						<div class="form-group">
		      					<label for="check_out_tour" class="head_bol"><?php _e('Arrive date', ST_TEXTDOMAIN); ?> <span class="text-small text-danger">(*)</span>:</label>
		      					<?php 
...
<div id="tour_time_content" style="padding:15px; display: none">
    <div class="row calendar-wrapper mb20 calendar-wrapper-inner">        
        <div class="col-xs-12">
