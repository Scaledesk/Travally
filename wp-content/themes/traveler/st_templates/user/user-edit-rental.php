...
?>
<div class="st-create">
    <h2 class="pull-left"><?php _e("Edit Rental",ST_TEXTDOMAIN) ?></h2>
...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner">
    ...
    <div class="form-group form-group-icon-left">
        ...
        <input id="title" name="title" type="text" placeholder="<?php echo __('Name of Rental', ST_TEXTDOMAIN); ?>" class="form-control" value="<?php echo esc_html($post->post_title) ?>">
                ...
                <div class="row">
                        ...
                        <div class='form-group form-group-icon-left'>
                            ...
                            if(!empty($layout) and is_array($layout)):
                                ...
                                <select class='form-control' name='st_custom_layout' id="st_custom_layout">
                                    <?php
                                    $st_custom_layout = get_post_meta($post_id , 'custom_layout' , true);
                    ...
                    <div class="col-md-6 clear">
                        <div class="form-group form-group-icon-left">
                            ...
                            <i class="fa  fa-cogs input-icon input-icon-hightlight"></i>
                            <input id="rental_number" name="rental_number" type="text" placeholder="<?php _e("Number of rental available for booking",ST_TEXTDOMAIN) ?>" class="form-control number" value="<?php echo get_post_meta($post_id,'rental_number',true) ?>">
                    ...
                    <div class='col-md-6'>
                        <div class="form-group form-group-icon-left">
                            ...
                            <input id="" name="rental_max_adult" type="text" placeholder="1" class="form-control number" value="<?php echo get_post_meta($post_id,'rental_max_adult',true) ?>">
                    ...
                    <div class='col-md-6'>
                        <div class="form-group form-group-icon-left">
                            ...
                            <i class="fa fa-plus-square input-icon input-icon-hightlight"></i>
                            <input id="" name="rental_max_children" type="text" placeholder="1" class="form-control number" value="<?php echo get_post_meta($post_id,'rental_max_children',true) ?>">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <input id="price" name="price" type="text" placeholder="<?php st_the_language('user_create_rental_price') ?>" class="form-control number" value="<?php echo get_post_meta($post_id,'price',true) ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <input id="discount" name="discount" type="text" placeholder="<?php _e("Discount Rate (%)",ST_TEXTDOMAIN) ?>" class="form-control number" value="<?php echo get_post_meta($post_id,'discount_rate',true) ?>">
                    ...
                    <div class="data_is_sale_schedule">
                        <div class="col-md-6 input-daterange">
                            <div class="form-group form-group-icon-left" >
                                ...
                                <input name="sale_price_from" class="date-pick form-control st_date_start" data-date-format="yyyy-mm-dd" type="text" value="<?php echo get_post_meta($post_id,'sale_price_from',true) ?>"/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left" >
                                ...
                                <i class="fa fa-calendar input-icon input-icon-hightlight"></i>
                                <input name="sale_price_to" class="date-pick form-control st_date_end" data-date-format="yyyy-mm-dd" type="text" value="<?php echo get_post_meta($post_id,'sale_price_to',true) ?>" />
                ...
                <div class="row">
                    <div class='col-md-12'>
                        <div class="form-group">
                            ...
                            <input id="rentals_booking_period" name="rentals_booking_period" type="number" min="0" placeholder="<?php _e("Booking Period (day)",ST_TEXTDOMAIN) ?>" class="form-control number" value="<?php echo get_post_meta($post_id,'rentals_booking_period',true) ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <i class="fa fa-cogs input-icon input-icon-hightlight"></i>
                            <?php $st_car_external_booking = get_post_meta($post_id , 'st_rental_external_booking' , true) ?>
                    ...
                    <div class='col-md-6 data_st_rental_external_booking'>
                        <div class="form-group form-group-icon-left">
                            ...
                            <i class="fa fa-link  input-icon input-icon-hightlight"></i>
                            <input id="st_rental_external_booking_link" name="st_rental_external_booking_link" type="text" placeholder="<?php _e("Eg: https://domain.com") ?>" class="form-control" value="<?php echo get_post_meta($post_id,'st_rental_external_booking_link',true) ?>">
    ...
    <div class="text-center div_btn_submit">
        ...
        <input name="btn_update_post_type_rental" id="btn_insert_post_type_rental" type="submit"  class="btn btn-primary hidden" value="SUBMIT">
    </div>
</form>
