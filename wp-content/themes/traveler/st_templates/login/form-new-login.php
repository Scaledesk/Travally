...
if(is_page_template('template-login.php')){
    ...
    if(empty($btn_sing_up))$btn_sing_up=__("Sign Up",ST_TEXTDOMAIN);
?>
...
<form  method="post" action="<?php echo esc_url(add_query_arg(array(
    ...
    <div class="form-group <?php echo esc_attr($class_form); ?> form-group-icon-left">
        <label for="field-user_name"><?php _e("User Name",ST_TEXTDOMAIN) ?></label>
        <i class="fa fa-user input-icon input-icon-show"></i>
    ...
    <div class="form-group <?php echo esc_attr($class_form); ?> form-group-icon-left">
        <label for="field-email"><?php st_the_language('email') ?></label>
    ...
    <div class="form-group <?php echo esc_attr($class_form); ?> form-group-icon-left">
        <label for="field-password"><?php st_the_language('password') ?></label>
