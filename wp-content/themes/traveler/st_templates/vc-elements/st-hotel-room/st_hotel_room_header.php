			...
			<?php else: ?>
				...
				<?php if(!empty($user->display_name)): ?>
					<h5 class="text-center">
						<a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php echo $user->display_name; ?></a>
					</h5>
				<?php endif; ?>
			<?php endif; ?>	
		</div>
			...
			<div class="row">
				<div class="col-xs-6 col-sm-3">
					<div class="facility-item" rel="tooltip" data-placement="top" title="" data-original-title="<?php echo __('Adults Occupancy', ST_TEXTDOMAIN); ?>">
						...
						<h5 class="booking-item-feature-sign"><?php echo $adult_number; ?> <?php echo ($adult_number >= 2)? __('adults', ST_TEXTDOMAIN) : __('adult', ST_TEXTDOMAIN) ?></h5>
					</div>
				</div>
				<div class="col-xs-6 col-sm-3">
					<div class="facility-item" rel="tooltip" data-placement="top" title="" data-original-title="<?php echo __('Childs', ST_TEXTDOMAIN); ?>">
						...
						<h5 class="booking-item-feature-sign"><?php echo $children_number; ?> <?php echo ($children_number >= 2)? __('children', ST_TEXTDOMAIN) : __('children', ST_TEXTDOMAIN); ?></h5>
					</div>
				</div>
				<div class="col-xs-6 col-sm-3">
					<div class="facility-item" rel="tooltip" data-placement="top" title="" data-original-title="<?php echo __('Beds', ST_TEXTDOMAIN); ?>">
						<i class="im im-bed"></i>
						<h5 class="booking-item-feature-sign"><?php echo $bed_number; ?> <?php echo ($bed_number >= 2)? __('beds', ST_TEXTDOMAIN) : __('bed', ST_TEXTDOMAIN); ?></h5>
					</div>
				</div>
				<div class="col-xs-6 col-sm-3">
					<div class="facility-item" rel="tooltip" data-placement="top" title="" data-original-title="<?php echo __('Room footage (square feet)', ST_TEXTDOMAIN); ?>">
						...
						<h5 class="booking-item-feature-sign"><?php echo $room_footage; ?> <?php echo 'm'; ?></h5>
					</div>
				</div>
			</div>
		</div>
