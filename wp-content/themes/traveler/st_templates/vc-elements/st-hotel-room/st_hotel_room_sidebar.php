...
<div class="hotel-room-form">
    ...
    <div class="price bgr-main clearfix">
        <div class="pull-left">
            <span class="text-lg"><?php echo TravelHelper::format_money($total_price) ?></span>
        </div>
    ...
    <div class="search_room_alert "></div>
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group form-group-icon-left">
                        ...
                        <input
                            ...
                            value="<?php echo date(TravelHelper::getDateFormat(),strtotime($check_in)); ?>" 
                            name="check_in" 
                            type="text">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group form-group-icon-left">
                        ...
                        <input
                            ...
                            value="<?php echo date(TravelHelper::getDateFormat(),strtotime($check_out)); ?>" 
                            name="check_out" 
                            type="text">
                    </div>
                </div>
        ...
        <?php             
            ...
            ?>
            <a class=" btn btn-primary btn_hotel_booking" data-effect="mfp-zoom-out" data-target="#hotel_booking_<?php echo get_the_ID(); ?>" type="submit"><?php echo __('Book Now', ST_TEXTDOMAIN); ?></a>
            <?php  }else{ ?>
