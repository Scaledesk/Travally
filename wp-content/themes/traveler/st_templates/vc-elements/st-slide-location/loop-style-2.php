                        ...
                        if($rental->is_available())
                        {
                            ...
                            if(!empty($offer)){
                                ...
                                if(!empty($page_search) and get_post_type($page_search)=='page'){
                                    ...
                                    $link = add_query_arg(array('pick-up'=>get_the_title(),'location_id'=>get_the_ID(),'s'=>'','st_rental'=>'st_hotel'),home_url('/'));
                                }
                        ...
                        if($car->is_available())
                        {
                            ...
                            if(!empty($offer)){
                                ...
                                if(!empty($page_search) and get_post_type($page_search)=='page'){
                                    ...
                                    $link = add_query_arg(array('pick-up'=>get_the_title(),'location_id_pick_up'=>get_the_ID(),'s'=>'','st_rental'=>'st_cars'),home_url('/'));
                                }

                                if($offer>1)
                                {
                                    $offer_string=sprintf(__('%d Cars from %s/day',ST_TEXTDOMAIN),$offer,$min_price);
                                }else{
                                    $offer_string=sprintf(__('%d Car from %s/day',ST_TEXTDOMAIN),$offer,$min_price);
                                }
                        ...
                        if($activity->is_available())
                        {
                            ...
                            if(!empty($offer)){
                                ...
                                if(!empty($page_search) and get_post_type($page_search)=='page'){
                                    ...
                                    $link = add_query_arg(array('pick-up'=>get_the_title(),'location_id'=>get_the_ID(),'s'=>'','st_rental'=>'st_activity'),home_url('/'));
                                }
