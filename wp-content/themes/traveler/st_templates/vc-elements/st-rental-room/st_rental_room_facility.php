				...
				<div class="col-xs-7 col-sm-9">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6 sub-item">
							...
							<span><?php if(!empty($item['facility_icon'])): ?><i class="<?php echo TravelHelper::handle_icon($item['facility_icon']); ?> mr5"></i><?php endif; ?><?php echo $item['title']; ?>: <strong><?php echo $item['value']; ?></strong></span>
						</div>
