...
<form id="hotel_search_half_map" method="get" class="search filter_search_map" action="<?php echo home_url() ?>">
    ...
    <div class="row">
        ...
        <?php if($range_km == 'on'): ?>
            <div class="col-md-<?php echo esc_attr( $range_km_col ) ?>">
                <label><?php _e( "Range Kilometers" , ST_TEXTDOMAIN ) ?></label>
    ...
    <!--<div class="form-group price_map" >
        <?php
/*        echo st()->load_template('hotel/filter_price',false,array('hidde_button'=>'true'));
    ...
    <button class="btn btn-primary btn_search" data-title="<?php st_the_language( 'search_for_hotel' ) ?>" type="submit"><?php st_the_language( 'search_for_hotel' ) ?></button>
    <hr>
</form>
