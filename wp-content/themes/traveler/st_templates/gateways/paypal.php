...
?>
    ...
    <div class="text-center">
        ...
        <?php }else{ ?>
            <input class="btn btn-primary btn-st-big st_payment_gatewaw_submit" type='submit' name='st_payment_gateway_st_paypal' value="<?php st_the_language('checkout_via_paypal')?>">
