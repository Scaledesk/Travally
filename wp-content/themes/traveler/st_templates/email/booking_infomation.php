        ...
        $i = 0;
            ...
            <tr>
                ...
                <td style="padding: 6px;vertical-align: top;border-bottom:1px dashed #ccc;border-left: 1px solid #bcbcbc;border-bottom: 1px solid #bcbcbc;border-right: 1px solid #bcbcbc;">
                    ...
                    <p><strong><?php _e('Number of rooms',ST_TEXTDOMAIN) ?>:</strong> <?php echo TravelHelper::format_money_from_db(get_post_meta($order_id, 'item_price',true), $currency, $rate); ?></p>
                    ...
                    ?>
                        <span>
                            <?php echo $extras['title'][$name].' ('.TravelHelper::format_money_from_db($price_item, $currency, $rate).') x '.$number_item.' '.__('Item(s)', ST_TEXTDOMAIN); ?>
                        </span> <br />
            ...
            <td  style="border-bottom: 1px solid #bcbcbc;border-right:1px solid #bcbcbc;padding: 6px;background: #e4e4e4;">
                <table cellspacing="0px" cellpadding="0" width="100%">
                    <tr>
                        ...
                        <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                            <?php echo TravelHelper::format_money_from_db($origin_price, $currency, $rate); ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                        ...
                        <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                            <?php echo TravelHelper::format_money_from_db($sale_price, $currency, $rate); ?>
                        </td>
                    </tr>
                    <?php if(isset($extras['value']) && is_array($extras['value']) && count($extras['value'])): ?>
                    <tr>
                        ...
                        <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                            <?php echo TravelHelper::format_money_from_db($extra_price, $currency, $rate) ?>
                        </td>
                    </tr>
                    <?php endif; ?>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                            <?php echo TravelHelper::format_money_from_db($price_with_tax, $currency, $rate); ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                            <?php echo TravelHelper::format_money_from_db($deposit_price, $currency, $rate); ?>
                        </td>
                    </tr>
                    <?php endif;?>
                    <tr>
                        ...
                        <td style="border-bottom: 1px dashed #ccc;padding:10px;">
                            <?php echo TravelHelper::format_money_from_db($total_price, $currency, $rate); ?>
                        </td>
                    </tr>
                </table>
            </td>
