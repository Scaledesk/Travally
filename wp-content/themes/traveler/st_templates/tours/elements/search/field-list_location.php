...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <label for="field-tour-locationid"><?php echo esc_html( $title)?></label>
    <i class="fa fa-map-marker input-icon"></i>
   <select id="field-tour-locationid" name="location_id" class="form-control" <?php echo esc_attr($is_required) ?>>
