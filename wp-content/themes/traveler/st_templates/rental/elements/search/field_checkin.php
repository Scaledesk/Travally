...
<div data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-group input-daterange  form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <input id="field-rental-checkin" <?php echo esc_attr($is_required) ?> placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-control checkin_rental <?php echo esc_attr($is_required) ?>" value="<?php echo STInput::get('start') ?>" name="start" type="text" />
</div>
