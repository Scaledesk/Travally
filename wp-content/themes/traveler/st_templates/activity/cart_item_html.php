...
if(isset($item_id) and $item_id):
    ...
    <header class="clearfix" style="position: relative">
        ...
        <a class="booking-item-payment-img" href="#">
            <?php echo get_the_post_thumbnail($activity_id,array(98,74,'bfi_thumb'=>true));?>
        </a>
    ...
    <ul class="booking-item-payment-details">
        <li>
            <h5><?php echo __('Activity Infomation', ST_TEXTDOMAIN); ?></h5>
        ...
        <li>
            <ul class="booking-item-payment-price">
                ...
                <?php if($type_activity == 'daily_tour' and $duration): ?>
                <li>
...
<div class="booking-item-payment-total text-right">
    ...
    <table border="0" class="table_checkout">
        <tr>
            ...
            <td class="text-right "><strong><?php echo TravelHelper::format_money($data_price['adult_price']); ?></strong></td>
        </tr>
        <tr>
            <td class="text-left title"><?php echo __('Children Price', ST_TEXTDOMAIN); ?></td>
            <td class="text-right "><strong><?php echo TravelHelper::format_money($data_price['child_price']); ?></strong></td>
        </tr>
        <tr>
            <td class="text-left title"><?php echo __('Infant Price', ST_TEXTDOMAIN); ?></td>
            <td class="text-right "><strong><?php echo TravelHelper::format_money($data_price['infant_price']); ?></strong></td>
        </tr>
        <tr>
