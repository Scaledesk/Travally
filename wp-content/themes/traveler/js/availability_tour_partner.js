			...
			self.calendar.fullCalendar({
				...
				eventRender: function(event, element, view){
					...
					if(event.status == 'available'){
						html += '<div class="price">Adult price: '+event.adult_price+'</div>';
						html += '<div class="price">Children price: '+event.child_price+'</div>';
						html += '<div class="price">Infant price: '+event.infant_price+'</div>';
