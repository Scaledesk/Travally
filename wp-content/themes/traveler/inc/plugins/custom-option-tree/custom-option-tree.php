...
class STCustomOptiontree
{
    ...
    function add_scripts()
    {
        ...
        {
            wp_register_script('select2-lang',$this->url.'/js/select2-3.5.2/select2_locale_'.$lang.'.js',array('jquery','select2'),null,true);
        }else{
            ...
            if(!empty($locale_array) and $locale_array[0] and $locale_array[0]!='en'){
                ...
                if(file_exists($lang_file))
                    wp_register_script('select2-lang',$this->url.'/js/select2-3.5.2/select2_locale_'.$locale.'.js',array('jquery','select2'),null,true);
            }
        }
