 ...
 * */
    class STCart
    {
        ...
        static function add_cart($item_id, $number = 1, $price = false, $data = array()){
            ...
            $data['duration'] = self::get_duration_unit($item_id) ; // from 1.1.9
        ...
        static function get_duration_unit($item_id){
            ...
            if ($post_type =='st_tours') return STTour::get_duration_unit($item_id);
            if ($post_type =='st_cars' ) return st()->get_option( 'cars_price_unit' , 'day' );
            return "day";
        }
        /**
