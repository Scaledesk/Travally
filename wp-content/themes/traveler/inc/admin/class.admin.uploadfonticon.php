...
if(!class_exists('STAdminUploadIcon')){
	...
	class STAdminUploadIcon extends STAdmin{
		...
		public function __construct(){
            ...
            add_action('admin_init',array($this,'_upload_font_handler'));
		}
		...
		**/
		public function removeFolderUpload(){
			remove_filter('upload_dir', array($this,'_awesome_fonticon_dir'));
		}
		...
		**/
		public function _register_uploadfont_submenu_page() {
			    add_submenu_page(apply_filters('ot_theme_options_menu_slug','st_traveler_options'), __('Importer Fonticon', ST_TEXTDOMAIN), __('Importer Fonticon', ST_TEXTDOMAIN), 'manage_options', 'st-upload-custom-fonticon', array($this,'_st_upload_icon_content' ));
		}
