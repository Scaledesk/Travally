        ...
        public function settings() {
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <input name="hotel_room_permalink"  type="text" value="<?php echo esc_attr( $hotel_room_permalink ); ?>" class="regular-text code">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="rental_room_permalink"  type="text" value="<?php echo esc_attr( $rental_room_permalink ); ?>" class="regular-text code">
                    </td>
                </tr>
                <tr>
