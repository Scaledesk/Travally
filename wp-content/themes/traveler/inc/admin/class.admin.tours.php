    ...
    class STAdminTours extends STAdmin
    {
        ...
        static function _getInfoTour(){
            ...
            if(get_post_type($tour_id) == 'st_tours'){
                ...
                if($type_tour && $type_tour == 'daily_tour'){
                    ...
                    $duration_unit = get_post_meta($tour_id, 'duration_unit', true);
        ...
        **/
        ...
        function _init_post_type()
        {
            ...
            $labels = array(
                'name'                       => __( 'Tour Categories', 'taxonomy general name', ST_TEXTDOMAIN ),
                'singular_name'              => __( 'Tour Categories', 'taxonomy singular name', ST_TEXTDOMAIN ),
                ...
                'not_found'                  => __( 'No Pickup Tour Categories.', ST_TEXTDOMAIN ),
            ...
            $this->metabox[] = array(
                ...
                'fields'      => array(
                    ...
                    array(
                        ...
                        'id'          => 'type_tour',
                        'type'        => 'select',
                        'desc'        =>__('Tour Type',ST_TEXTDOMAIN),
                        'choices'   =>array(
                            array(
                                'value'=>'daily_tour',
        ...
        function _check_validate(){
            ...
            if(STInput::request('section', '') != 'edit_order_item'){
                ...
                if(!$check_in || !$check_out){
                    STAdmin::set_message(__( 'Select a tour in the calendar above.' , ST_TEXTDOMAIN ) , 'danger' );
                    $pass_validate = FALSE;
                    return false;
                }
