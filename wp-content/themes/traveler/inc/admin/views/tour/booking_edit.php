...
?>
<div class="wrap">
    <?php echo '<h2>'.$page_title.'<a href="'.admin_url('edit.php?post_type=st_tours&page=st_tour_booking&section=add_booking').'" class="add-new-h2">'.__('Add New',ST_TEXTDOMAIN).'</a></h2>';?>
    <?php STAdmin::message() ?>
                    ...
                    <div id="poststuff">
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    <label class="form-label" for="tour_time"><?php _e('Select a tour',ST_TEXTDOMAIN)?><span class="require"> (*)</span></label>
                                ...
                                <?php endif; ?>
                                <?php if($section != 'add_booking' && $tour_type == 'daily_tour'): $duration_unit = get_post_meta($order_item_id, 'duration_unit', true);?>
                                <div class="form-row">
