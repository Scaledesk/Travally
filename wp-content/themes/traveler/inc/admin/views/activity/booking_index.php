...
echo '<h2>'.__('Activity Booking',ST_TEXTDOMAIN).'<a href="'.admin_url('edit.php?post_type=st_activity&page=st_activity_booking&section=add_booking').'" class="add-new-h2">'.__('Add New',ST_TEXTDOMAIN).'</a></h2>';
    ...
    STAdmin::message();
?>
<form id="posts-filter" action="<?php echo admin_url('edit.php?post_type=st_activity&page=st_activity_booking')?>" method="get">
...
<form id="posts-filter" action="<?php echo admin_url('edit.php?post_type=st_activity&page=st_activity_booking')?>" method="post">
    ...
    <table class="wp-list-table widefat fixed posts">
        <thead>
            <tr>
                ...
                <th class="manage-column">
                    <a href="#"><span><?php _e('Activity Name',ST_TEXTDOMAIN)?></span><span class="sorting-indicator"></span></a>
                </th>
                <th class="manage-column " width="7%">
                    <a href="#"><span><?php _e('Number',ST_TEXTDOMAIN)?></span><span class="sorting-indicator"></span></a>
                </th>
                <th class="manage-column" width="7%">
                    <a href="#"><span><?php _e('Total Price',ST_TEXTDOMAIN)?></span><span class="sorting-indicator"></span></a>
                </th>
                <th class="manage-column"  width="10%">
