...
$paging['base']=admin_url('edit.php?post_type=st_cars&page=st_hotel_booking%_%');
$paging['format']='&paged=%#%';
$paging['total']=$total;
$paging['current']=$page;
...
echo '<h2>'.__('Car Booking',ST_TEXTDOMAIN).'<a href="'.admin_url('edit.php?post_type=st_cars&page=st_car_booking&section=add_booking').'" class="add-new-h2">'.__('Add New',ST_TEXTDOMAIN).'</a></h2>';

    STAdmin::message();
?>
<form id="posts-filter" action="<?php echo admin_url('edit.php?post_type=st_cars&page=st_car_booking')?>" method="get">
...
<form id="posts-filter" action="<?php echo admin_url('edit.php?post_type=st_cars&page=st_car_booking')?>" method="post">
                        ...
                        <tr class="<?php if ($i % 2 == 0) echo 'alternate'; ?>">
                            ...
                            <td class="post-title page-title column-title">
                                <strong><a class="row-title"
                                           href="<?php echo admin_url('edit.php?post_type=st_cars&page=st_car_booking&section=edit_order_item&order_item_id=' . $post_id); ?>"
                                           title=""><?php
                                        $order = $post_id;
                                        if ($order) {
                                ...
                                <div class="row-actions">
                                    <a href="<?php echo admin_url('edit.php?post_type=st_cars&page=st_car_booking&section=edit_order_item&order_item_id=' . $post_id); ?>"><?php _e('Edit',ST_TEXTDOMAIN)?></a> |
