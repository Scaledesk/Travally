                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        ?>
                                        <input name="total_price" type="text" readonly value="<?php echo TravelHelper::format_money_from_db($total_price, $currency, $rate); ?>" class="form-control form-control-admin "><?php _e('Auto calculate',ST_TEXTDOMAIN)?>
                                    </div>
                                </div>
                                <div class="form-row">
