                    ...
                    <div id="poststuff">
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    <label class="form-label" for=""><?php _e('Hotel',ST_TEXTDOMAIN)?><span class="require"> (*)</span></label>
                                    <div class="controls">
                                    <?php 

                                        $hotel_id = intval(get_post_meta($item_id,'item_id',true));
                                        if(get_post_type($hotel_id) == 'st_hotel' && $section == 'edit_order_item'):
                                    ?>
                                        <select name="item_id" id="item_id" class="form-control form-control-admin">
                                            <option value="<?php echo $hotel_id ?>"><?php echo get_the_title($hotel_id); ?></option>
                                        </select>
                                    <?php endif; ?>
                                    <?php 
                                        $hotel_id = isset($_POST['item_id']) ? intval($_POST['item_id']) : '';
                                        $hotel_name = (get_post_type($hotel_id) == 'st_hotel') ? get_the_title($hotel_id) : '';
                                        if($section == 'add_booking'):
                                    ?>
                                        <input id="item_id" type="hidden" name="item_id" value="<?php echo $hotel_id; ?>" data-post-type="st_hotel" class="form-control form-control-admin st_post_select_ajax " data-pl-name="<?php echo $hotel_name; ?>">
                                    <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <label class="form-label" for=""><?php _e('Room',ST_TEXTDOMAIN)?><span class="require"> (*)</span></label>
                                    <div class="controls">
                                    <?php 
                                        $room_id = intval(get_post_meta($item_id, 'room_id', true));
                                        if(get_post_type($room_id) == 'hotel_room' && $section == 'edit_order_item'):
                                    ?>
                                        <select name="room_id" id="room_id" class="form-control form-control-admin">
                                            <option value="<?php echo $room_id ?>"><?php echo get_the_title($room_id); ?></option>
                                        </select>
                                    <?php endif; ?>
                                    <?php 
                                        if($section == 'add_booking'):
                                            $room_id = isset($POST['room_id']) ? intval($_POST['room_id']) : '';
                                    ?>
                                    <div id="room-id-wrapper" data-room-id="<?php echo $room_id; ?>">
                                        
                                    </div>
                                    <span class="spinner room_id"></span>
                                    <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <?php else:
                                        $item_price = isset($_POST['item_price']) ? $_POST['item_price'] : TravelHelper::format_money_raw(0);
                                    ?>
                                ...
                                <div class="form-row">
                                    <label class="form-label" for=""><?php _e('Number Room',ST_TEXTDOMAIN)?><span class="require"> (*)</span></label>
                                    <div class="controls">
                                    <?php 
                                        $item_number = isset($_POST['item_number']) ? $_POST['item_number'] : get_post_meta($item_id,'item_number',true);
                                    ?>
                                        <input type="text" name="item_number" value="<?php echo $item_number; ?>" class="form-control form-control-admin ">
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    ?>
                                        <input readonly placeholder="mm/dd/yyyy" type="text" name="check_in" value="<?php echo $check_in; ?>" class="form-control form-control-admin st_datepicker ">
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    ?>
                                        <input readonly placeholder="mm/dd/yyyy" type="text" name="check_out" value="<?php echo  $check_out; ?>" class="form-control form-control-admin st_datepicker">
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        <?php 
                                            if($section == 'edit_order_item' && get_post_type($room_id) == 'hotel_room'):
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        <select data-block="" class="form-control form-control-admin" name="status">
