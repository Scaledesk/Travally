...
echo '<h2>'.__('Hotel Bookings',ST_TEXTDOMAIN).'<a href="'.admin_url('edit.php?post_type=st_hotel&page=st_hotel_booking&section=add_booking').'" class="add-new-h2">'.__('Add New',ST_TEXTDOMAIN).'</a></h2>';
