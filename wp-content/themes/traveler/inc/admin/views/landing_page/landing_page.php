...
<div class='st_landing_page'>
	...
	<section>
		<section class='about_text'>
			...
			<a href="<?php echo esc_url($video_link) ; ?>" class="thickbox" title="Guided Tour of Avada">Watch Our Quick Guided Tour!</a>
		</section>
		<section class='logo'>
		...
		<section class='landing_page_content'>
			...
			<div class="traveler-thanks">
		        <p class="description"><?php echo __("Thank you for choosing traveler. We are honored and are fully dedicated to making your experience perfect.", ST_TEXTDOMAIN) ; ?></p>
		    </div>
		</section>
	</section>
