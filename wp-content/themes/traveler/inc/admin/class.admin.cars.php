            ...
            if($car_id <= 0 || get_post_type($car_id) != 'st_cars'){
                ...
                if(is_array($item_equipment) && count($item_equipment)){
                    ...
                    foreach($item_equipment as $key => $val){
                        ...
                        <label for="item_equipment-'.$i.'"><input id="item_equipment-'.$i.'" type="checkbox" name="item_equipment[]" value="'.$val['title'].'--'.$cars_equipment_list_price.'">'.$val['title'].'('.$cars_equipment_list_price.')</label>
                        </div>';
                        $i ++;
                    }
            ...
            if(is_array($data) && count($data)){
                ...
                if($order_id){
                    ...
                    $item_data  = array(
                        ...
                        'drop_off'             => get_the_title($location_id_drop_off),
